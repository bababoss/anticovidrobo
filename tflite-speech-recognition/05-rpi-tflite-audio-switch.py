...
def sd_callback(rec, frames, time, status):
    ...
    if status:
        print('Error:', status)
    (sample_rate,rec) = wav.read("/home/pi/dataset/yes/6982fc2a_nohash_0.wav")
...
#     rec = np.squeeze(rec)
    ...
    print("new_fs:   ",new_fs)
#     rec, new_fs = librosa.load("/home/pi/dataset/yes/6982fc2a_nohash_0.wav", sr=resample_rate)
...
#     window[len(window)//2:] = rec
    ...
    print("output_data-1",output_data)
    val = output_data[0][0]
